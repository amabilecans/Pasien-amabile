...
function exportAllData() {
    ...
    let csvContent = 'Nama,Tanggal Lahir,Umur,Jenis Kelamin,Pekerjaan,Alamat,Agama,Total Kunjungan,Tanggal Pemeriksaan,Jumlah Gigi Diperiksa,Kondisi Gigi\n';
    ...
    allData.forEach(patient => {
        ...
        csvContent += `"${patient.name}","${patient.birthDate}",${patient.age},"${patient.gender}","${patient.occupation}","${patient.address}","${patient.religion}",${totalVisits},"${patient.examDate}",${teethCount},"${conditions}"\n`;
    });
